...
tn.write(b"set interfaces ethernet eth1 vif 100\n")
tn.write(b"set interfaces ethernet eth1 vif 200\n")
tn.write(b"set interfaces ethernet eth1 vif 300\n")
tn.write(b"set interfaces ethernet eth1 vif 400\n")
tn.write(b"exit\n")
